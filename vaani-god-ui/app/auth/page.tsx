...
export default function VaaniApp() {
  ...
  if (loadingSession) {
    return <div className="min-h-[50vh] flex items-center justify-center font-mono text-xs tracking-widest uppercase text-gray-500">Verifying Clearance...</div>;
  }

  return (
    <div className="w-full text-[#111] font-sans selection:bg-black selection:text-white pb-20">
      
      {/* 🌟 RESPONSIVE NAVIGATION CONTROL (Moved out of header) */}
